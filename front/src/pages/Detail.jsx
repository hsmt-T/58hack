    ...
    const fetchRoomInfoAndConnect = async () => {
      try {
        ...
        const res = await fetch(
          `https://five8hack-backend.onrender.com/chat/${room_id}`,
          {
            method: "GET",
            headers: {
        ...
        socket = new WebSocket(
          `wss://five8hack-backend.onrender.com/chat/${room_id}`
        );
        ws.current = socket;
